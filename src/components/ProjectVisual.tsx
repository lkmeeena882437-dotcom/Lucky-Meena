export function ProjectVisual({ type }: { type: string }) {
        ...
        <div className="art-browser">
          ...
          <div className="console-grid">
            ...
            <div className="console-main">
              ...
              <strong>Member signal</strong>
              <div className="chart-line">
                <svg viewBox="0 0 260 90">
                  <path d="M0 78C31 73 37 49 70 56s43-32 73-20 35-18 60-5 31-20 57-25" />
                </svg>
              </div>
    ...
    return (
      <div className="project-art art-advertising" aria-hidden="true">
        ...
        <div className="ad-phone">
          <span className="ad-notch" />
          <small>TELEGRAM CAMPAIGN</small>
          <strong>
            Audience fit
            <br />
            before reach.
        ...
        <div className="ad-float ad-float-a">
          <small>CHANNELS</small>
          <strong>Research</strong>
        </div>
        <div className="ad-float ad-float-b">
  ...
  if (type === 'automation') {
    return (
      <div className="project-art art-automation" aria-hidden="true">
        <svg className="flow-lines" viewBox="0 0 600 380">
          <path d="M110 190h84c35 0 26-86 74-86h65c47 0 39 86 83 86h77" />
          <path d="M194 190h74c42 0 32 88 78 88h70" />
        </svg>
        <div className="flow-node node-lead">
          <i>01</i>
          <span>Lead</span>
        </div>
        ...
        <div className="flow-node node-route">
          <i>03</i>
          <span>Route</span>
        </div>
        ...
        <div className="flow-node node-report">
          <i>05</i>
          <span>Report</span>
        </div>
      </div>
  ...
  return (
    <div className="project-art art-web" aria-hidden="true">
      <div className="web-window window-back">
        <div />
        <span />
        <span />
        <i />
      </div>
      <div className="web-window window-front">
        ...
        <div className="window-copy">
          ...
          <strong>Make the value feel obvious.</strong>
          <span />
          <button />
        </div>
        <div className="window-orb" />
      </div>
